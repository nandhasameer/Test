...
namespace OnlineSlots.Api.Helpers
{
    using System;
    ...
    public static class SqlHelper
    {
        ...
        /// <param name="TimeOut">Timeout in seconds, with default</param>
        /// <returns>Datatable or null</returns>
        public static DataSet ExecuteStoredProcedureWithDataSet(string connectionString, string ProcedureName, List<SqlParameter> parameters, int TimeOut = Timeout_Default)
        {
            DataSet ds = new DataSet();
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
